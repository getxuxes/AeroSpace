...
== center-floating
----
include::aerospace-center-floating.adoc[tags=synopsis]
----
include::aerospace-center-floating.adoc[tags=purpose]
include::aerospace-center-floating.adoc[tags=body]
