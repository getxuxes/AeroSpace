...
Floating windows can be moved only with `--boundaries all-monitors-outer-frame`.
The floating window is moved to the monitor in the given direction, keeping its relative position and size.
