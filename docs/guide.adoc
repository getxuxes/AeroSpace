...
Switching between tiling and floating (`layout floating`, `layout tiling`) and `center-floating` are animated too.
Switching workspaces, moving floating windows and fullscreen windows are not animated.
