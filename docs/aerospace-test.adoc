...
%{window-parent-container-layout}:: String. The layout (`v_tiles`, `h_tiles`, `floating`) of the window's parent container.
...
%{workspace-root-container-layout}:: String. The layout (`v_tiles`, `h_tiles`) of the workspace the window belongs to.
